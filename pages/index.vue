        ...
        <div class="mt-10 mb-16 space-y-8 px-2">
          ...
          <ExplanationContainer title="ทวงสัญญากับฝ่ายค้านได้ด้วยเหรอ?">
            <img
              ...
              :src="`${$config.public.path.images}/topic/proposed.png`"
              alt="proposed"
            />
            <p class="wv-font-baijamjuri wv-b6 text-white">
              <span class="wv-font-bold"
                >บทบาทหลักของฝ่ายค้านในรัฐสภา
                คือการตรวจสอบการทำงานของรัฐบาล</span
              >
              และแม้จะเป็นการยากที่จะผลักดันเสียงของประชาชนด้วยเสียงข้างน้อย
              แต่เราก็อยากลองชวนทุกคนทบทวนดูว่า พวกเขาพยายามเพื่อเราแค่ไหน
              ดังนั้น สำหรับพรรคฝ่ายค้าน หากดำเนินการมาถึงขั้นตอน "เสนอต่อสภา"
              ขึ้นไป หรือใช้กลไกของสภา เช่น การอภิปราย การตั้งกระทู้ถาม
              นั่นแสดงให้เห็นว่า
